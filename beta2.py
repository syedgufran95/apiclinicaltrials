...
def initial():
	...
	csvwriter.writerow(["nct_id","overall_status","start_date","completion_date","condition","Study design info","eligibility","has_expanded_access","enrollment"])
...
api.add_resource(People,'/nct_id/<string:nct_idu>')
